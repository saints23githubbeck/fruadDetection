<div class="modal fade " id="deleteAccType-{{$accountType->id}}" tabindex="-1" role="dialog"
     aria-hidden="true">
    <div class="modal-dialog success-modal-content modal-dialog-centered" role="document">
        <div class="modal-content bg-white">
            <div class="modal-header">
                <h5 class="modal-title text-center text-capitalize" id="exampleModalLabel">Delete Account Type</h5>
            ...
            <div class="modal-footer">
                <form  action="{{route('account.type.destroy',$accountType)}}" method="post">
                    @method('DELETE')
                    @csrf
