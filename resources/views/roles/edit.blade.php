        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content ">
                <div class="modal-header">
                    <h5 class="modal-title text-center text-capitalize" id="exampleModalLabel">Update Tax </h5>
                                    ...
                                    <div class="row w-100 p-2">
                                        <div class="col-md-12 mb-4 pl-0 ">
                                            ...
                                            <input type="text" name="role" class="form-control @error('role') is-invalid @enderror" id="role"
                                                   placeholder="Name" value="{{ old('role',$role->name) }}" >
                                                ...
                                                @foreach ($permissions as $permission)
                                                    ...
                                                    <div class="col-md-2 col-sm-2 col-4">
                                                        <label class="switch checkbox-inline">
                                                            <input type="checkbox" name="permission[{{$permission->name}}]"   @if(isset($role)) checked @endif>
