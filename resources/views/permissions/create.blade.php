        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content ">
                <div class="modal-header">
                    <h5 class="modal-title text-center text-capitalize" id="exampleModalLabel">Add Category </h5>
                ...
                <div class="modal-body">
                    ...
                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-md-6 mb-4 pl-0">
                                            ...
                                            <textarea name="description" maxlength="50" cols="30" rows="5" class="form-control @error('description') is-invalid @enderror"
